...
parser.add_argument('--total_num', type=int, nargs='?', default=50, help='number of examples for each task')
...
parser.add_argument('--valid_batch', type=int, nargs='?', default=1, help='validating batch size')
...
parser.add_argument('--buffer_size', type=int, nargs='?', default=128, help='number of examples stored per task')
