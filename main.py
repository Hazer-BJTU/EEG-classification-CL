...
parser.add_argument('--cvae_coefs', nargs='+', default=[1, 1, 1], help='coefficients for CVAE')
parser.add_argument('--visualize', type=bool, nargs='?', help='require visualization when CGR')
